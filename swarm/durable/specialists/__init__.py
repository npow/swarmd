...
from swarm.durable.specialists.llm_critic import LLMCriticWorkflow
from swarm.durable.specialists.pattern_detector import (
    PatternDetectorWorkflow,
    _run_pattern_rules,
)
from swarm.durable.specialists.resource_monitor import (
