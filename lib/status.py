...
from swarm.lib.paths import session_dir, validate_session_id  # noqa: E402

import json as _json  # local alias to avoid shadowing
import time  # noqa: E402
from typing import Any  # noqa: E402
from swarm.lib.launcher_liveness import launcher_alive as _launcher_alive_check  # noqa: E402
...
def _load_interventions(
    ...
    from swarm.lib.paths import interventions_acked_path, interventions_path
...
def _load_health(session_id: str, stale_sec: float = STALE_SEC) -> tuple[list[SpecialistHealth], int]:
    ...
    from swarm.lib.paths import session_dir as _sdir
...
def _find_most_recent() -> str | None:
    from swarm.lib.paths import events_path as _ep, swarm_root
